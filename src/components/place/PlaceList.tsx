...
const PlaceList = ({ places, focusedIndex, onItemClick }: PlaceListProps) => {
    return (
        <ul className="absolute top-full left-0 w-full mt-2 bg-white border border-gray-200 rounded-3xl shadow-xl overflow-hidden py-4 z-50 max-h-[400px] overflow-y-auto">
            {places.length === 0 && (
