function DestinationRow({ title, description, onClick, isActive }) {
  return (
    <button
      type="button"
      onClick={onClick}
      className={`w-full flex items-start gap-4 rounded-3xl p-4 text-left transition-colors ${isActive ? 'bg-gray-100' : 'hover:bg-gray-100'}`}
    >
